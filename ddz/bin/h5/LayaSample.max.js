...
//class com.google.protobuf.CodedInputStream
var CodedInputStream=(function(){
	function CodedInputStream(input,length){
		...
		this._buffer=input;
		this._bytesAvailable=length >=0 ? length :input.bytesAvailable;
	}

	__class(CodedInputStream,'com.google.protobuf.CodedInputStream');
	var __proto=CodedInputStream.prototype;
	//-----------------------------------------------------------------
	__proto.readTag=function(){
		if (this._bytesAvailable <=0 || this._buffer.bytesAvailable==0){
			this._lastTag=0;
			return 0;
		}
		this._lastTag=this.readRawVarint32();
		if (WireFormat.getTagFieldNumber(this._lastTag)==0){
			throw InvalidProtocolBufferException.invalidTag();
		}
		return this._lastTag;
	}

	__proto.skipRawBytes=function(size){
		this.readRawBytes(size);
	}

	__proto.checkLastTagWas=function(value){
		if (this._lastTag !=value){
			throw InvalidProtocolBufferException.invalidEndTag();
		}
	}

	__proto.skipField=function(tag){
		switch (WireFormat.getTagWireType(tag)){
			...
			case 3:
				this.skipMessage();
				this.checkLastTagWas(WireFormat.makeTag(WireFormat.getTagFieldNumber(tag),
				4));
				return true;
			case 4:
				return false;
	...
	__proto.readSInt32=function(){
		return CodedInputStream.decodeZigZag32(this.readRawVarint32());
	}

	__proto.readFixed32=function(){
		return this.readRawLittleEndian32();
	}

	__proto.readSFixed32=function(){
		return this.readRawLittleEndian32();
	}

	__proto.readInt64=function(){
		return this.readRawVarint64();
	}

	__proto.readUInt64=function(){
		return this.readRawVarint64();
	}

	__proto.readSInt64=function(){
		return CodedInputStream.decodeZigZag64(this.readRawVarint64());
	}

	__proto.readFixed64=function(){
		return this.readRawLittleEndian64();
	}

	__proto.readSFixed64=function(){
		return this.readRawLittleEndian64();
	}

	__proto.readFloat=function(){
		return CodedInputStream.intBitsToFloat(this.readRawLittleEndian32());
	}

	__proto.readDouble=function(){
		return CodedInputStream.longBitsToDouble(this.readRawLittleEndian64());
	}
	...
	__proto.readEnum=function(){
		return this.readRawVarint32();
	}

	__proto.readString=function(){
		var length=this.readRawVarint32();
		return this.readRawBytes(length).readUTFBytes(length);
	}
	...
	__proto.readMessage=function(msg){
		if (this._recursionDepth >=100){
			throw InvalidProtocolBufferException.recursionLimitExceeded();
		};
		var length=this.readRawVarint32();
		var stream=new CodedInputStream(this._buffer,length);
		this._bytesAvailable-=length;
		++this._recursionDepth;
		stream._recursionDepth=this._recursionDepth;
		msg.readFrom(stream);
		--this._recursionDepth;
		return msg;
	}

	__proto.readMap=function(keyType,valueType,value,keyTag,valueTag){
		var key=null;
		var length=this.readRawVarint32();
		var input=new CodedInputStream(this._buffer,length);
		this._bytesAvailable-=length;
		while (true){
		...
		if (key==null){
			key=this.primitiveDefaultValue(keyType);
		}
		if (value==null){
			value=this.primitiveDefaultValue(valueType);
		}
		return new MapEntry(key,value);
	}

	__proto.readPrimitiveField=function(type){
		switch (type){
			case 0:
	...
	__proto.primitiveDefaultValue=function(type){
		switch (type){
			case 12:
				return false;
			case 14:
	...
	__proto.readPackedVector=function(value,type){
		var length=this.readRawVarint32();
		var input=new CodedInputStream(this._buffer,length);
		this._bytesAvailable-=length;
	...
	//-----------------------------------------------------------------
	__proto.readRawByte=function(){
		if (this._bytesAvailable <=0){
			throw InvalidProtocolBufferException.truncatedMessage();
		}
		this._bytesAvailable--;
		return this._buffer.readByte();
	}

	__proto.readRawBytes=function(length){
		if (length < 0){
			throw InvalidProtocolBufferException.negativeSize();
		}
		if (length > this._bytesAvailable){
			throw InvalidProtocolBufferException.truncatedMessage();
		};
		var bytes=new ByteArray();
		if (length !=0){
			this._bytesAvailable-=length;
			this._buffer.readBytes(bytes,0,length);
		}
		return bytes;
	}

	__proto.readRawVarint32=function(){
	...
	__proto.readRawLittleEndian32=function(){
	...
	__proto.readRawVarint64=function(){
		var shift=0;
		var result=new Int64(0,0);
		while (shift < 64){
	...
	__proto.readRawLittleEndian64=function(){
		var low=this.readRawLittleEndian32();
		var high=this.readRawLittleEndian32();
	...
	CodedInputStream.decodeZigZag32=function(n){
		return (n >>> 1)^-(n & 1);
	}

	CodedInputStream.decodeZigZag64=function(n){
		return n.shiftRight(1).xor(new Int64(-(n.low & 1),-(n.low & 1)));
	}

	CodedInputStream.intBitsToFloat=function(value){
		var bytes=new ByteArray();
	...
	CodedInputStream.longBitsToDouble=function(value){
		var bytes=new ByteArray();
		bytes.endian="littleEndian";
	...
	CodedInputStream.RECURSION_LIMIT=100;
	return CodedInputStream;
})()


//class com.google.protobuf.CodedOutputStream
var CodedOutputStream=(function(){
	function CodedOutputStream(output){
		this._buffer=null;
		this._buffer=output;
	}

	__class(CodedOutputStream,'com.google.protobuf.CodedOutputStream');
	var __proto=CodedOutputStream.prototype;
	//-------------------------------------------------------------------------
	__proto.writeTag=function(fieldNumber,wireType){
		this.writeRawVarint32(WireFormat.makeTag(fieldNumber,wireType));
	}

	__proto.writeInt32=function(fieldNumber,value){
		this.writeTag(fieldNumber,0);
		this.writeInt32NoTag(value);
	}

	__proto.writeUInt32=function(fieldNumber,value){
		this.writeTag(fieldNumber,0);
		this.writeUInt32NoTag(value);
	}

	__proto.writeSInt32=function(fieldNumber,value){
		this.writeTag(fieldNumber,0);
		this.writeSInt32NoTag(value);
	}

	__proto.writeFixed32=function(fieldNumber,value){
		this.writeTag(fieldNumber,5);
		this.writeFixed32NoTag(value);
	}

	__proto.writeSFixed32=function(fieldNumber,value){
		this.writeTag(fieldNumber,5);
		this.writeSFixed32NoTag(value);
	}

	__proto.writeInt64=function(fieldNumber,value){
		this.writeTag(fieldNumber,0);
		this.writeInt64NoTag(value);
	}

	__proto.writeUInt64=function(fieldNumber,value){
		this.writeTag(fieldNumber,0);
		this.writeUInt64NoTag(value);
	}

	__proto.writeSInt64=function(fieldNumber,value){
		this.writeTag(fieldNumber,0);
		this.writeSInt64NoTag(value);
	}

	__proto.writeFixed64=function(fieldNumber,value){
		this.writeTag(fieldNumber,1);
		this.writeFixed64NoTag(value);
	}

	__proto.writeSFixed64=function(fieldNumber,value){
		this.writeTag(fieldNumber,1);
		this.writeSFixed64NoTag(value);
	}

	__proto.writeFloat=function(fieldNumber,value){
		this.writeTag(fieldNumber,5);
		this.writeFloatNoTag(value);
	}

	__proto.writeDouble=function(fieldNumber,value){
		this.writeTag(fieldNumber,1);
		this.writeDoubleNoTag(value);
	}

	__proto.writeBool=function(fieldNumber,value){
		this.writeTag(fieldNumber,0);
		this.writeBoolNoTag(value);
	}

	__proto.writeEnum=function(fieldNumber,value){
		this.writeTag(fieldNumber,0);
		this.writeEnumNoTag(value);
	}

	__proto.writeString=function(fieldNumber,value){
		this.writeTag(fieldNumber,2);
		this.writeStringNoTag(value);
	}

	__proto.writeBytes=function(fieldNumber,value){
		this.writeTag(fieldNumber,2);
		this.writeBytesNoTag(value);
	}

	__proto.writeMessage=function(fieldNumber,value){
		this.writeTag(fieldNumber,2);
		this.writeMessageNoTag(value);
	}

	__proto.writeMap=function(entries,filedNumber,keyType,valueType){
		var entry;
		for(var $each_entry in entries){
			entry=entries[$each_entry];
	...
	__proto.writeVector=function(value,number,type){
		for (var i=0;i < value.length;i++){
			if (value[i] !=null){
				this.writeField(number,type,value[i]);
			}
		}
	}

	__proto.writePackedVector=function(value,number,type){
		var bytes=new ByteArray();
		var output=new CodedOutputStream(bytes);
		for (var i=0;i < value.length;i++){
			if (value[i]==null){
		...
		this.writeTag(number,2);
		this.writeRawVarint32(bytes.length);
		this.writeRawBytes(bytes);
	}

	//------------------------------------------------------------------------
	__proto.writeField=function(number,type,value){
		switch (type){
			case 0:
			...
			case 1:
				...
				break ;
			case 3:
				this.writeInt64(number,value);
				break ;
			case 5:
				this.writeUInt64(number,value);
				break ;
			case 2:
			...
			case 8:
				...
				break ;
			case 12:
				this.writeBool(number,value);
				break ;
			case 13:
				this.writeString(number,value);
				break ;
			case 14:
				this.writeBytes(number,value);
				break ;
			case 4:
				this.writeUInt32(number,value);
				break ;
			case 15:
				this.writeEnum(number,value);
				break ;
			case 10:
				this.writeSFixed32(number,value);
				break ;
			case 11:
				this.writeSFixed64(number,value);
				break ;
			case 6:
				this.writeSInt32(number,value);
				break ;
			case 7:
				this.writeSInt64(number,value);
				break ;
			case 16:
				this.writeMessage(number,value);
				break ;
			default :
				throw new Error("Unknown type: "+type);
			}
	...
	__proto.writeInt32NoTag=function(value){
		if (value >=0){
			this.writeRawVarint32(value);
			}else {
			this.writeRawVarint64(new Int64(~0,value));
		}
	}

	__proto.writeUInt32NoTag=function(value){
		this.writeRawVarint32(value);
	}

	__proto.writeSInt32NoTag=function(value){
		this.writeRawVarint32(CodedOutputStream.encodeZigZag32(value));
	}

	__proto.writeFixed32NoTag=function(value){
		this.writeRawLittleEndian32(value);
	}

	__proto.writeSFixed32NoTag=function(value){
		this.writeRawLittleEndian32(value);
	}

	__proto.writeInt64NoTag=function(value){
		this.writeRawVarint64(value);
	}

	__proto.writeUInt64NoTag=function(value){
		this.writeRawVarint64(value);
	}

	__proto.writeSInt64NoTag=function(value){
		this.writeRawVarint64(CodedOutputStream.encodeZigZag64(value));
	}

	__proto.writeFixed64NoTag=function(value){
		this.writeRawLittleEndian64(value);
	}

	__proto.writeSFixed64NoTag=function(value){
		this.writeRawLittleEndian64(value);
	}

	__proto.writeFloatNoTag=function(value){
		this.writeRawLittleEndian32(CodedOutputStream.floatToRawIntBits(value));
	}

	__proto.writeDoubleNoTag=function(value){
		this.writeRawLittleEndian64(CodedOutputStream.doubleToRawLongBits(value));
	}

	__proto.writeBoolNoTag=function(value){
		this.writeRawByte(value ? 1 :0);
	}

	__proto.writeEnumNoTag=function(value){
		this.writeRawVarint32(value.value);
	}

	__proto.writeStringNoTag=function(value){
		var bytes=new ByteArray();
		bytes.writeUTFBytes(value);
		this.writeBytesNoTag(bytes);
	}

	__proto.writeBytesNoTag=function(value){
		this.writeRawVarint32(value.length);
		this.writeRawBytes(value);
	}

	__proto.writeMessageNoTag=function(value){
		var bytes=new ByteArray();
	...
	//------------------------------------------------------------------------
	__proto.writeRawByte=function(value){
		this._buffer.writeByte(value);
	}

	__proto.writeRawBytes=function(value){
		this._buffer.writeBytes(value,0,value.length);
	}

	__proto.writeRawVarint32=function(value){
		while (true){
			if ((value & ~0x7F)==0){
	...
	__proto.writeRawLittleEndian32=function(value){
	...
	__proto.writeRawVarint64=function(value){
		while (true){
			if (value.high==0 && ((value.low & ~0x7F)==0)){
				this.writeRawByte(value.low);
				return;
				}else {
				this.writeRawByte((value.low & 0x7F)| 0x80);
				value=value.shiftRight(7);
			}
		}
	}

	__proto.writeRawLittleEndian64=function(value){
		this.writeRawByte((value.low >>> 0)& 0xFF);
		this.writeRawByte((value.low >>> 8)& 0xFF);
		this.writeRawByte((value.low >>> 16)& 0xFF);
		this.writeRawByte((value.low >>> 24)& 0xFF);
		this.writeRawByte((value.high >>> 0)& 0xFF);
		this.writeRawByte((value.high >>> 8)& 0xFF);
		this.writeRawByte((value.high >>> 16)& 0xFF);
		this.writeRawByte((value.high >>> 24)& 0xFF);
	}

	CodedOutputStream.encodeZigZag32=function(n){
		return (n << 1)^ (n >> 31);
	}

	CodedOutputStream.encodeZigZag64=function(n){
		return n.shiftLeft(1).xor(n.shiftRight(63));
	}

	CodedOutputStream.floatToRawIntBits=function(value){
		var bytes=new ByteArray();
		bytes.endian="littleEndian";
	...
	CodedOutputStream.doubleToRawLongBits=function(value){
		var bytes=new ByteArray();
		bytes.endian="littleEndian";
...
var Enum=(function(){
	...
	__class(Enum,'com.google.protobuf.Enum');
	var __proto=Enum.prototype;
...
//class com.google.protobuf.FieldDescriptorType
var FieldDescriptorType=(function(){
	function FieldDescriptorType(){}
	__class(FieldDescriptorType,'com.google.protobuf.FieldDescriptorType');
	FieldDescriptorType.DOUBLE=0;
	FieldDescriptorType.FLOAT=1;
	FieldDescriptorType.INT32=2;
	FieldDescriptorType.INT64=3;
	FieldDescriptorType.UINT32=4;
	FieldDescriptorType.UINT64=5;
	FieldDescriptorType.SINT32=6;
	FieldDescriptorType.SINT64=7;
	FieldDescriptorType.FIXED32=8;
	FieldDescriptorType.FIXED64=9;
	FieldDescriptorType.SFIXED32=10;
	FieldDescriptorType.SFIXED64=11;
	FieldDescriptorType.BOOL=12;
	FieldDescriptorType.STRING=13;
	FieldDescriptorType.BYTES=14;
	FieldDescriptorType.ENUM=15;
	FieldDescriptorType.MESSAGE=16;
	FieldDescriptorType.MAP=17;
	return FieldDescriptorType;
})()


//class com.google.protobuf.Int64
var Int64=(function(){
	...
	__class(Int64,'com.google.protobuf.Int64');
	...
	__proto.toString=function(){
		var high="00000000"+uint(this._high).toString(16);
		var low="00000000"+uint(this._low).toString(16);
		return "0x"+high.substr(high.length-8)+low.substr(low.length-8);
	}

	__proto.equal=function(other){
		return other._high==this._high && other._low==this._low;
	}

	__proto.shiftRight=function(bit){
		var high=this._high;
		var low=this._low;
		if (bit >=64){
			high=0;
	...
	__proto.shiftLeft=function(bit){
		var high=this._high;
		var low=this._low;
		if (bit >=64){
			high=0;
	...
	__proto.xor=function(other){
		return new Int64(this._high ^ other._high,this._low ^ other.low);
	}

	__proto.and=function(other){
		return new Int64(this._high & other._high,this._low & other.low);
	}

	__proto.or=function(other){
		return new Int64(this._high | other._high,this._low | other.low);
	}

	__getset(0,__proto,'low',function(){
		return this._low;
		},function(value){
		this._low=value;
	});
...
//class com.google.protobuf.MapEntry
var MapEntry=(function(){
	...
	__class(MapEntry,'com.google.protobuf.MapEntry');
	var __proto=MapEntry.prototype;
...
//class com.google.protobuf.Message
var Message=(function(){
	function Message(){}
	__class(Message,'com.google.protobuf.Message');
	var __proto=Message.prototype;
	__proto.writeTo=function(output){}
	__proto.readFrom=function(input){}
	Message.toByteArray=function(message){
		var bytes=new ByteArray();
...
//class com.google.protobuf.WireFormat
var WireFormat=(function(){
	function WireFormat(){}
	__class(WireFormat,'com.google.protobuf.WireFormat');
	WireFormat.getTagWireType=function(tag){
		return tag & WireFormat.TAG_TYPE_MASK;
	}

	WireFormat.getTagFieldNumber=function(tag){
		return tag >> 3;
	}

	WireFormat.makeTag=function(fieldNumber,wireType){
		return (fieldNumber << 3)| wireType;
	}

	WireFormat.WIRETYPE_VARINT=0;
	WireFormat.WIRETYPE_FIXED64=1;
	WireFormat.WIRETYPE_LENGTH_DELIMITED=2;
	WireFormat.WIRETYPE_START_GROUP=3;
	WireFormat.WIRETYPE_END_GROUP=4;
	WireFormat.WIRETYPE_FIXED32=5;
	WireFormat.TAG_TYPE_BITS=3;
	__static(WireFormat,
	['TAG_TYPE_MASK',function(){return this.TAG_TYPE_MASK=(1 << 3)-1;}
	]);
	return WireFormat;
})()
...
*@dengcs
*/
//class common.GameConstants
var GameConstants=(function(){
	function GameConstants(){}
	__class(GameConstants,'common.GameConstants');
	GameConstants.stageWidth=1140;
	__static(GameConstants,
	['stageHeight',function(){return this.stageHeight=(1140 *3)/ 4;}
	]);
...
//class com.google.protobuf.InvalidProtocolBufferException extends Error
var InvalidProtocolBufferException=(function(_super){
	function InvalidProtocolBufferException(description){
		InvalidProtocolBufferException.__super.call(this,description);
	}

	__class(InvalidProtocolBufferException,'com.google.protobuf.InvalidProtocolBufferException',Error);
	...
	InvalidProtocolBufferException.negativeSize=function(){
		return new InvalidProtocolBufferException(
	...
	InvalidProtocolBufferException.invalidTag=function(){
		return new InvalidProtocolBufferException(
	...
	InvalidProtocolBufferException.invalidWireType=function(){
		return new InvalidProtocolBufferException(
	...
	InvalidProtocolBufferException.sizeLimitExceeded=function(){
		return new InvalidProtocolBufferException(
...
*@dengcs
*/
//class com.google.protobuf.ByteArray extends laya.utils.Byte
var ByteArray=(function(_super){
	function ByteArray(data){
		ByteArray.__super.call(this,data);
	}

	__class(ByteArray,'com.google.protobuf.ByteArray',_super);
...
var query_players=(function(_super){
	...
	__proto.writeTo=function(output){
		if (!(this._account.length==0)){
			output.writeString(1,this._account);
		}
		_super.prototype.writeTo.call(this,output);
	}
	...
	__proto.readFrom=function(input){
		while(true){
			...
			switch(tag){
				...
				case 10:{
						this._account=input.readString();
						break ;
					}
				}
		}
	...
	__getset(0,__proto,'account',function(){
